defmodule ArchitectureGenerator.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      ArchitectureGeneratorWeb.Endpoint
    ]

    # See https://hexdocs.pm/elixir/Supervisor.html
    # for other strategies and supported options
    opts = [strategy: :one_for_one, name: ArchitectureGenerator.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    ArchitectureGeneratorWeb.Endpoint.config_change(changed, removed)
    :ok
  end
